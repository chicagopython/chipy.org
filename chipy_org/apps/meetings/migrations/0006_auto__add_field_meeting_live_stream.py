...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.live_stream'
        db.add_column('meetings_meeting', 'live_stream',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting.live_stream'
        db.delete_column('meetings_meeting', 'live_stream')
    ...
    models = {
        ...
        'meetings.meeting': {
            ...
            'live_stream': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True'}),
