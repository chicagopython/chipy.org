...
from .views import AfterSubmitJobPost, JobPostDetail, JobPostList, create_job_post, delete_job_post, update_job_post
...
urlpatterns = [
    ...
    path("", JobPostList.as_view(), name="job-post-list"),
