...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Meeting', fields ['key']
        db.create_unique('meetings_meeting', ['key'])


    def backwards(self, orm):
        # Removing unique constraint on 'Meeting', fields ['key']
        db.delete_unique('meetings_meeting', ['key'])
