...
urlpatterns = [
    ...
    url(r"^topics/propose/user/$", login_required(ProposeTopicList.as_view()), name="propose_topics_user"),
    url(r"^topics/propose/user/(?P<topic_id>[0-9]*)/$", login_required(ProposeTopicDraftAdd.as_view()), name="propose_topic_user"),
